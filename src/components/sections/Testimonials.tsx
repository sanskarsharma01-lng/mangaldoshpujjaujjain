...
export const Testimonials: React.FC = () => {
  ...
  return (
    <section className="section-padding bg-primary-dark text-ivory relative overflow-hidden" id="devotee-experiences">
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="max-w-3xl mx-auto relative px-4 sm:px-8">
          <div className="min-h-[220px] sm:min-h-[180px] flex items-center justify-center">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {/* Quote */}
                <blockquote className="text-lg sm:text-xl font-serif italic text-ivory/90 leading-relaxed max-w-2xl mx-auto">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-ivory/60 text-xs tracking-wider uppercase">
          ...
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full border border-gold/20 flex items-center justify-center text-gold hover:bg-gold hover:text-primary transition-all duration-300 focus-visible:outline-none"
          >
            ‹
          </button>
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full border border-gold/20 flex items-center justify-center text-gold hover:bg-gold hover:text-primary transition-all duration-300 focus-visible:outline-none"
          >
            ›
          </button>
            ...
            {testimonials.map((_, idx) => (
              <button
                ...
                className={`w-2.5 h-2.5 rounded-full transition-all duration-300 focus-visible:outline-none ${
                  currentIndex === idx ? 'bg-gold w-6' : 'bg-ivory/20 hover:bg-ivory/40'
                }`}
              />
            ))}
          </div>
