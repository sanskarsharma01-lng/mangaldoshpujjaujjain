          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 flex justify-center">
              <ScrollReveal direction="left" delay={0.2} className="w-full max-w-sm">
                <div className="relative aspect-square rounded-3xl bg-primary shadow-primary-lg flex items-center justify-center p-8 overflow-hidden border-2 border-gold/30">
                  ...
                  <div className="relative z-10 text-center space-y-4">
                    ...
                    <div>
                      <p className="text-ivory font-poppins font-bold text-2xl tracking-wide">{pandit.name}</p>
                      <p className="text-gold/80 text-sm tracking-wider uppercase mt-1">{pandit.experience} Experience</p>
                    </div>
                  </div>
