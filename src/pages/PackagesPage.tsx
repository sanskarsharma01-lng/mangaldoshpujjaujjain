...
export const PackagesPage: React.FC = () => {
  ...
  const title = `Mangal Dosh Puja Packages & Price in Ujjain | ${siteConfig.name}`;
  const description = `Explore transparent pricing packages (Basic, Standard, Premium) for Mangal Dosh Puja and Mangal Bhat Puja in Ujjain. Complete ritual arrangements.`;
        ...
        <div className="bg-primary text-ivory py-12 md:py-16 text-center relative overflow-hidden">
          ...
          <div className="container-custom relative z-10 space-y-3">
            ...
            <h1 className="text-3xl md:text-5xl font-poppins font-bold">
              {t('nav.pujaPackages')} & Pricing
            </h1>
            <p className="text-ivory/70 text-sm md:text-base max-w-xl mx-auto font-light">
              Clear, transparent pricing and feature breakdowns for all Vedic ritual options in Ujjain.
            </p>
          </div>
        </div>
